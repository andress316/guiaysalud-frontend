...
const Header = () => {
  ...
  return (
    <>
      <nav className="z-20 bg-white dark:bg-slate-800 fixed md:static w-full md-w-auto boder-b md:border-none shadow-lg md_shadow-none dark:boder-none transition">
